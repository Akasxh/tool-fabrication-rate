...
and gpt-4o tiers also log $0\%$ TFR ($0/2{,}070$ pooled, $\leq\!0.14\%$).
Qwen3 isn't: its rate is non-monotone in
...
listing ($\mathrm{C}_{0.7}$; $0/448$ on Qwen3-8B, Clopper--Pearson 95\%
upper bound $\leq\!0.67\%$) already hits zero, and a
...
Qwen3-8B probe arms ($0/410$, $\leq\!0.73\%$: near\_name $0/97$, synonym $0/106$,
matched\_random $0/107$, unrelated $0/100$), matching $\mathrm{C}_{0.7}$
($0/448$) and the real list $\mathrm{C}_1$ ($0/258$); registry content is
